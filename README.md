...
* **Automated Transaction Logic:** Developed PL/SQL stored procedures (`add_payment.sql`) with multi-branch validation to enforce business rules and prevent orphaned financial records.
